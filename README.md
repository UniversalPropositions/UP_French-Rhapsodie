...
- `git clone https://github.com/UniversalPropositions/UP_French-Rhapsodie.git`
...
- `python3 up2/merge_ud_up.py --input_ud=<ud_path_to_UD_French-Rhapsodie>/ --input_up=<up_path_to_UP_French-Rhapsodie>/ --output=<path_to_UD+UP_French-Rhapsodie>/`
